...
{
  border: none;
    image: url(image/checkbox_unchecked_focus.png);
}
...
{
  border: none;
    image: url(image/checkbox_checked_focus.png);
}


QCheckBox::indicator:indeterminate
{
    image: url(image/checkbox_indeterminate.png);
}
...
{
    image: url(image/checkbox_indeterminate_focus.png);
}

QCheckBox::indicator:checked:disabled,
QGroupBox::indicator:checked:disabled
{
    image: url(image/checkbox_checked_disabled.png);
}

QCheckBox::indicator:unchecked:disabled,
QGroupBox::indicator:unchecked:disabled
{
    image: url(image/checkbox_unchecked_disabled.png);
}
...
{
    image: url(image/radio_unchecked.png);
}
...
QRadioButton::indicator:unchecked:pressed
{
    border: none;
    outline: none;
    image: url(image/radio_unchecked_focus.png);
}
...
QRadioButton::indicator:checked
{
    border: none;
    outline: none;
    image: url(image/radio_checked.png);
}
...
QRadioButton::indicator:checked:pressed
{
    border: none;
    outline: none;
    image: url(image/radio_checked_focus.png);
}

QRadioButton::indicator:checked:disabled
{
    outline: none;
    image: url(image/radio_checked_disabled.png);
}

QRadioButton::indicator:unchecked:disabled
{
    image: url(image/radio_unchecked_disabled.png);
}
...
QToolBar::separator:vertical {
    image: url(image/Vsepartoolbar.png);
}
...
QTabBar QToolButton::right-arrow:disabled {
     image: url(image/right_arrow_disabled.png);
 }

 QTabBar QToolButton::left-arrow:disabled {
     image: url(image/left_arrow_disabled.png);
 }
...
QTreeView::branch:closed:has-children:has-siblings:hover {
    image: url(image/branch_closed-on.png);
    }

QTreeView::branch:open:has-children:!has-siblings:hover,
QTreeView::branch:open:has-children:has-siblings:hover  {
    image: url(image/branch_open-on.png);
    }
